...
func (r *Repository) GetTransactionsByKey(key string) ([]dto.TransactionDTO, error) {
	const op = "internal.repository.postgres.transaction.GetTransactionsByKey"

	query, like := search_query.BuildTransactionQuery(key)
